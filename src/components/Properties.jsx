  ...
  return (
    <div>
      ...
      <div className=" flex flex-col max-sm:pt-20 md:py-8  md:flex-row justify-evenly">
        <div className="basis-1/2 pr-2  md:pt-40"><h1 className="text-white max-sm:text-4xl md:text-6xl font-normal">One streamlined hiring experience property-wide</h1>
        <p className="text-fuchsia-700 max-sm:text-2xl md:text-3xl py-8 font-normal">Help your properties hire the best candidates with a powerful, shared candidate pipeline</p>
